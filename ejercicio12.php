...
<body>
    ...
    <main>
 <form action="extraterrestres.php" method="POST">
    <div class="contenedor">
    <label for="nombreVisitante">Nombre del visitante:</label>
    <input type="text" name="nombreVisitante" id="nombreVisitante">
    </div>
    <div class="contenedor">
    <label for="planetaVisitante">Planeta perteneciente:</label>
    <select name="planetaVisitante" id="planetaVisitante">
        <option value="1">Jupiter</option>
        <option value="2">Marte</option>
        <option value="3">Saturno</option>
        <option value="4">Urano</option>
    </select>
    </div>
    <div class="contenedor">
